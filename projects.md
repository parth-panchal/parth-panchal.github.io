...
Understood, pre-processed and analyzed the *[New York City Bus Data](https://www.kaggle.com/stoney71/new-york-city-transport-statistics)* dataset, and visualised the bus traffic for each hour of a particular day on a Folium map using the HeatMapWithTime plug-in.
